...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500;600;700;800;900&display=…
    rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;500;600;700;800;900&display=sw…
    rel="stylesheet">
    ...
    <div class="offcanvas-menu-wrapper">
        <div class="offcanvas__cart">
            <div class="offcanvas__cart__links">
                <a href="#" class="search-switch"><img src="../../View/img/search.png" alt=""></a>
                <a href="#"><img src="../../View/img/heart.png" alt=""></a>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="class__form">
                        <div class="section-title">
                            <h2>Inicio de<br />Sesion</h2>
                        </div>
                        <form action="">
                            <input type="text" placeholder="Nombre de Usuario">
                            <input type="text" placeholder="Correo Electronico">
                            <button type="submit" class="site-btn">Iniciar Sesion</button>
                            <a href="Registro.php" class="d-block text-center mt-2">
                                ¿Deseas registrarte?
                            </a>
                ...
                <div class="class__image">
                    <img src="../../View/img/Inicio-pan.jpg" alt="">
                </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="footer__widget">
                        ...
                        <ul>
                            ...
                            <li>Sábados: 10:00 am – 16:30 pm</li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="footer__newslatter">
                        <h6>Suscribete</h6>
                        <p>Obtén nuestras últimas ofertas y noticias</p>
                        <form action="#">
