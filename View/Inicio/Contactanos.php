    ...
    <section class="mt-5 mb-5">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <h2 class="text-center mb-4" style="color: #f08632; font-weight: 700;" >Contáctanos</h2>
                        ...
                        <div class="col-md-6">
                            <div class="card shadow-lg border-0 rounded-4 h-100" style="background-color: #f8f9fa;">
                                <div class="card-body p-4">
                                    <h4 class="card-title mb-4 text-center" style="color: #f08632; font-weight: 700;">Envíanos un mensaje</h4>
                                    <form action="" method="POST" id="formContacto">
                                        <div class="mb-3">
                                            <label for="nombre" class="form-label" style="color: #f08632; font-weight: 700;">Nombre Completo</label>
                                            <input type="text" class="form-control" id="nombre" name="nombre"
                                                   placeholder="Ingresa tu nombre" required>
                                        </div>
                                       
                                        <div class="mb-3">
                                            <label for="email" class="form-label" style="color: #f08632; font-weight: 700;">Correo Electrónico</label>
                                            <input type="email" class="form-control" id="email" name="email"
                                                   placeholder="tu@email.com" required>
                                        </div>
                                       
                                        <div class="mb-3">
                                            <label for="telefono" class="form-label" style="color: #f08632; font-weight: 700;">Teléfono</label>
                                            <input type="tel" class="form-control" id="telefono" name="telefono"
                                                   placeholder="+506 0000-0000" required>
                                        </div>
                                       
                                        <div class="mb-3">
                                            <label for="asunto" class="form-label" style="color: #f08632; font-weight: 700;">Asunto</label>
                                            <input type="text" class="form-control" id="asunto" name="asunto"
                                                   placeholder="Motivo de tu consulta" required>
                                        </div>
                                       
                                        <div class="mb-3">
                                            <label for="mensaje" class="form-label" style="color: #f08632; font-weight: 700;">Mensaje</label>
                        ...
                        <div class="col-md-6">
                            <div class="card shadow-lg border-0 rounded-4 h-100" style="background-color: #f8f9fa;">
                                <div class="card-body p-4 d-flex flex-column justify-content-center">
                                    <h4 class="card-title mb-4 text-center" style="color: #f08632; font-weight: 700;">Información de Contacto</h4>
                                    ...
                                    <div class="mb-4 text-center">
                                        <div class="d-flex align-items-center justify-content-center mb-3">
                                            ...
                                            <div>
                                                <h6 class="mb-1"><strong>Dirección</strong></h6>
                                        ...
                                        <div class="d-flex align-items-center justify-content-center mb-3">
                                            ...
                                            <div>
                                                <h6 class="mb-1"><strong>Teléfono</strong></h6>
                                    ...
                                    <div class="mt-4 text-center">
                                        <h6 class="mb-3" style="color: #f08632; font-weight: 700;">Horario de Atención</h6>
